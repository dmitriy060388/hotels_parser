...
from src.pages.hotel_page.psql_connect import DBNAME, DBUSER, DBPASSWORD, DBHOST, DBPORT, LOGGING #1
...
while x != 0:
    for i in range(len(hotels)):
        ...
        table_insert(conn, "mts_scheme", "result", tabmaxid, parser.rooms_card, 'NULL', parser.rooms_price, 'NULL', 'NULL', LOGGING) #1
        time.sleep(5)
