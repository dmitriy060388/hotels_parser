...
cursor.fetchall()
print('yeah2')
cur.execute("INSERT INTO mts_test_1.results (id, hotel_name, date, price, category, breakfast) VALUES (%s, %s, %s, %s, %s, %s);",(1,"pavelyaga", datetime.date(2023, 1, 1), 1610, "standard", 1))
cursor.fetchall()
conn.close()
